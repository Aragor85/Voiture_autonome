...
if uploaded_file:
    # Lecture de l'image utilisateur
    ...
    # Envoi à l'API FastAPI (retry max 300s)
    max_wait = 300
    ...
    try:
        ...
        st.error(f"❌ Erreur lors de la lecture de la réponse API : {e}")
        st.stop()

    # Recoloration du masque en RGB selon la palette
